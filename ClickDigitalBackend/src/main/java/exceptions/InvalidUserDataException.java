...
public class InvalidUserDataException extends Exception implements Serializable {
    ...
    private static final Logger logger = LogManager.getLogger(InvalidUserDataException.class.getName());

    // Standard exception constructors
    public InvalidUserDataException() {
        super();
        logger.log(Level.ERROR, new Log(LogConstants.EMPTY_FIELD, InvalidUserDataException.class.getName(), LogConstants.EMPTY_FIELD, LogConstants.EMPTY_FIELD));
    }

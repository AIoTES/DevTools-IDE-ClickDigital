...
public class MissingParameterException extends Exception implements Serializable {
    ...
    private static final Logger logger = LogManager.getLogger(MissingParameterException.class.getName());
    public MissingParameterException() {
        super();
        logger.log(Level.ERROR, new Log(LogConstants.EMPTY_FIELD, MissingParameterException.class.getName(), LogConstants.EMPTY_FIELD, LogConstants.EMPTY_FIELD));
    }

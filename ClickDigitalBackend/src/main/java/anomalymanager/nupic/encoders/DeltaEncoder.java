...
public class DeltaEncoder extends AdaptiveScalarEncoder {
	...
	/**
	 * {@inheritDoc}
	 * @see AdaptiveScalarEncoder#init()
	 */
	@Override
	public void init() {
		super.init();
	...
	/**
	 * {@inheritDoc}
	 * @see AdaptiveScalarEncoder#initEncoder(int, double, double, int, double, double)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see AdaptiveScalarEncoder#getBucketInfo(int[])
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see AdaptiveScalarEncoder#topDownCompute(int[])
	 */
	@Override

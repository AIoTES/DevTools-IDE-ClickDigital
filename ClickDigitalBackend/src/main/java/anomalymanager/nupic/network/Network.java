...
import anomalymanager.nupic.network.sensor.Publisher;
import anomalymanager.nupic.network.sensor.Sensor;
import anomalymanager.nupic.network.sensor.SensorFactory;
 ...
 * altered in place without changing the values in the original Parameters object, by calling {@link Layer#alterParameter(Parameters.KEY, Object)}
 ...
 * </pre>
 * 
 * In addition there are many usage examples to be found in the {@link anomalymanager.nupic.examples.napi.hotgym} package

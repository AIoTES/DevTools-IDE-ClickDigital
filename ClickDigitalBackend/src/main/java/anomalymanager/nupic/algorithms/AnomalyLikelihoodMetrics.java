...
public class AnomalyLikelihoodMetrics implements Persistable {
     ...
     * @param params            {@link AnomalyLikelihood.AnomalyParams} which are a {@link Statistic}, array of likelihoods,
    ...
    public AnomalyLikelihoodMetrics copy() {
        ...
        return new AnomalyLikelihoodMetrics(
            ...
            aggRecordList, 
            new AnomalyLikelihood.AnomalyParams(params.keys(), vals.toArray()));
    }
    ...
    /**
     * <pre>
     * Returns the {@link AnomalyLikelihood.AnomalyParams} which is:

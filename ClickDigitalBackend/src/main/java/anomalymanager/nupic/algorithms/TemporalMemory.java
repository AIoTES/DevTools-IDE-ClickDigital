 ...
 * ---------------------------------------------------------------------
 */
package anomalymanager.nupic.algorithms;

import static anomalymanager.nupic.util.GroupBy2.Slot.NONE;
...
import anomalymanager.nupic.model.Connections.Activity;
import anomalymanager.nupic.model.DistalDendrite;
import anomalymanager.nupic.model.Synapse;
import anomalymanager.nupic.monitor.ComputeDecorator;
import anomalymanager.nupic.util.GroupBy2;
import anomalymanager.nupic.util.GroupBy2.Slot;
import anomalymanager.nupic.util.SparseObjectMatrix;
